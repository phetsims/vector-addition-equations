 ...
 * please modify vector-addition-equations/package.json to control dependencies.
 *
 * RequireJS configuration file for the vector-addition-equations sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'vector-addition-equations-main' ],
