...
=============
"Vector Addition: Equations" is an educational simulation in HTML5,
by <a href="https://phet.colorado.edu/" target="_blank">PhET Interactive Simulations</a>
at the University of Colorado Boulder.
For a description of this simulation, associated resources, and a link to the published version,
<a href="https://phet.colorado.edu/en/simulation/vector-addition-equations" target="_blank">visit the simulation's web
page</a>.
...
Click here to run "Vector Addition: Equations".</a>
...
(5) Open in the browser: `http://localhost/vector-addition-equations/vector-addition-equations_en.html` (You will
...
Help us improve, create a <a href="http://github.com/phetsims/vector-addition-equations/issues/new" target="_blank">New
Issue</a>
